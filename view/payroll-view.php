		...
		<div class="content">
			...
			<table id="table">
				...
				<tbody>
					...
					?>
					<tr>
						<td><?php echo $d->payroll_id; ?></td>
						<td><?php echo $d->employee_id;?></td>
						<td><?php echo $d->basic;?></td>
						<td><?php echo $d->allowance;?></td>
						<td><?php echo $d->bonus;?></td>
						<td><?php echo $d->total;?></td>

						<td><a href="payroll-edit.php?ids=<?php echo $d->payroll_id; ?>">Edit</a></td>
						<td><a href="../controller/payroll-delete.php?ids=<?php echo $d->payroll_id; ?>">Delete</a></td>
					</tr>
					<?php 
}
					?>
