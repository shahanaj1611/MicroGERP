			...
			<table id="table">
				...
				<tbody>
					...
					<tr>
						...
						<td><?php echo $d->company_address;?></td>
						<td><?php echo $d->purchase_quantity;?></td>
						<td><a href="buyer-info-edit.php?ids=<?php echo $d->buyer_id; ?>">Edit</a></td>
						<td><a href="../controller/buyer-info-delete.php?ids=<?php echo $d->buyer_id; ?>">Delete</a></td>
					</tr>
					<?php 
}
					?>
