	...
	<div class="main-content">
		<div class="content">
			...
			<table id="table">
				...
				<tbody>
					<?php
					$sql="select * from asset_tracking";
					...
					<tr>
						...
						<td><?php echo $d->limited_item;?></td>
						<td><?php echo $d->extra_item;?></td>

						<td><a href="asset-tracking-edit.php?ids=<?php echo $d->product_id; ?>">Edit</a></td>
						<td><a href="../controller/asset-tracking-delete.php?ids=<?php echo $d->product_id; ?>">Delete</a></td>
					</tr>
					<?php 
}
					?>
