		...
		<div class="content">
			...
			<table id="table">
				...
				<tbody>
					...
					?>
					<tr>
						<td><?php echo $d->meeting_id; ?></td>
						<td><?php echo $d->buyer_id;?></td>
						<td><?php echo $d->meeting_place;?></td>
						<td><?php echo $d->date;?></td>
						<td><?php echo $d->time;?></td>
						<td><a href="meeting-edit.php?ids=<?php echo $d->meeting_id; ?>">Edit</a></td>
						<td><a href="../controller/meeting-delete.php?ids=<?php echo $d->meeting_id; ?>">Delete</a></td>
					</tr>
					<?php 
}
					?>
