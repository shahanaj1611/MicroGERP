	...
	<div class="main-content">
		<div class="content">
			<div class="registion-form">
				 <h2>Update Now</h2>
				 <?php
$sql = "select * from contract where contract_id='". $_GET['ids']."'";
$data = $conn->query($sql);
while($d = $data->fetch_object()) {
?>
				 <form action="../controller/contract-update.php" method="post">
				 	<input type="hidden" name="contract_id"  value="<?php echo $d->contract_id?>"><br>
					...
					<label>buyer_id</label><br>
				 	...
				 	<label>issue_date</label><br>
				 	<input type="text" name="issue_date"  value="<?php echo $d->issue_date;?>"><br>
					
				 	<label>deadline</label><br>
				 	<input type="text" name="deadline"  value="<?php echo $d->deadline;?>"><br>
