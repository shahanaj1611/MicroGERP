			...
			<table id="table">
				...
				<tbody>
					...
					<tr>
						...
						<td><a href="personal_info-edit.php?ids=<?php echo $d->employee_id; ?>">Edit</a></td>
						<td><a href="../controller/personal_info-delete.php?ids=<?php echo $d->employee_id; ?>">Delete</a></td>
					</tr>
					<?php 
}
					?>
