			...
			<table id="table">
				...
				<tbody>
					...
					<tr>
						...
						<td><a href="contract-edit.php?ids=<?php echo $d->contract_id; ?>">Edit</a></td>
						<td><a href="../controller/contract-delete.php?ids=<?php echo $d->contract_id; ?>">Delete</a></td>
					</tr>
					<?php 
}
					?>
