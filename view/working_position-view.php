	...
	<div class="main-content">
		<div class="content">
			...
			<table id="table">
				...
				<tbody>
					<?php
					$sql="select * from working_position";
					$result=mysqli_query($conn,$sql);
					while ($d=$result->fetch_object()){
					?>
					<tr>
						<td><?php echo $d->position_id; ?></td>
						<td><?php echo $d->employee_id;?></td>
						<td><?php echo $d->department;?></td>
						<td><?php echo $d->position;?></td>
						<td><?php echo $d->working_hour;?></td>
						<td><?php echo $d->working_zone;?></td>
						
						<td><a href="working_position-edit.php?ids=<?php echo $d->position_id; ?>">Edit</a></td>
						<td><a href="../controller/working_position-delete.php?ids=<?php echo $d->position_id; ?>">Delete</a></td>
					</tr>
					<?php 
}
					?>
