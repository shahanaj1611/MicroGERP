		...
		<div class="content">
			...
			<table id="table">
				...
				<tbody>
					...
					?>
					<tr>
						<td><?php echo $d->ordering_id; ?></td>
						<td><?php echo $d->product_id;?></td>
						<td><?php echo $d->ordering_item;?></td>
						<td><?php echo $d->ordering_date;?></td>
						<td><?php echo $d->arrival_date;?></td>
						<td><a href="ordering-edit.php?ids=<?php echo $d->ordering_id; ?>">Edit</a></td>
						<td><a href="../controller/ordering-delete.php?ids=<?php echo $d->ordering_id; ?>">Delete</a></td>
					</tr>
					<?php 
}
					?>
